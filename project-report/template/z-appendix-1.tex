...
This appendix contains the complete EasyCrypt proofs for the key lemmas used in our vector operations and algebraic manipulations. These proofs are extracted directly from our \texttt{INDCCA.ec} file without modification. The full formal verification code is available at: \url{https://github.com/GuSheldom/INDCCA-QDDH/blob/main/INDCCA.ec}
...
\section{prodEx sizele Proofs}
\label{sec:prodex-sizele-proofs}
...
\section{sumv cons Proofs}
\label{sec:sumv-cons-proofs}
